          ...
          <div className="grid grid-cols-3 gap-6 max-[900px]:grid-cols-1">
            {articles.map((article, i) => (
              <Reveal
                key={i}
                delay={i * 100}
                className="rounded-[6px] overflow-hidden hover:shadow-[0_6px_32px_rgba(58,46,40,0.1)] hover:-translate-y-1 flex flex-col"
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  {article.description && (
                    <p className="text-[14px] font-normal text-[#7b6b5a] leading-[1.8] flex-1">
                      {article.description}
                    </p>
                  )}
                </div>
